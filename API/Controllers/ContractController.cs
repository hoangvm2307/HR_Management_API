...
namespace API.Controllers
{
    ...
    public class ContractController : ControllerBase
    {
            ...
            PersonnelContractCreationDTO personnelContractCreationDTO)
        {
            ...
            personnelContractCreationDTO.CreateAt = DateTime.UtcNow.AddHours(7);
        ...
        public async Task<ActionResult<PersonnelContractDTO>> UpdatePersonnelContract(
            int staffId, 
            int contractId, 
            PersonnelContractUpdateDTO personnelContractUpdateDTO)
        {
            if (!await _userInfoService.IsUserExist(staffId))
            {
                return NotFound();
            ...
            personnelContractUpdateDTO.CreateAt = DateTime.UtcNow.AddHours(7);
                ...
                )
        {
            ...
            contractFromStore.ChangeAt = DateTime.UtcNow.AddHours(7);
